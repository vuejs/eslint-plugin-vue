...
module.exports = {
  ...
  *iterateArrowFunctionExpression(node, groupName) {
    ...
    while (true) {
      switch (target.type) {
        ...
        case 'MemberExpression': {
          if ((propProps || isRootProps) && target.object === node) {
            isRootProps = false
  ...
  /**
   Checks whether the tokens of two given nodes are same.
