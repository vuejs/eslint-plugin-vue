...
module.exports = {
  ...
  * iterateArrowFunctionExpression (node, groupName) {
  ...
  /**
   * Get the chaining nodes of CallExpression or MemberExpression.
   *
   * @param  {ESLintNode} node The node to parse (MemberExpression | CallExpression)
   * @return {ESLintNode[]} The chaining nodes
   */
  getMemberOrCallChaining (node) {
    const nodes = []
    let n = node
