...
const { getScope } = require('./scope.ts')
...
const VUE2_BUILTIN_COMPONENT_NAMES = new Set(
  require('./vue2-builtin-components.ts').default
)
const VUE3_BUILTIN_COMPONENT_NAMES = new Set(
  require('./vue3-builtin-components.ts').default
)
const VUE_BUILTIN_ELEMENT_NAMES = new Set(
  require('./vue-builtin-elements.ts').default
)
