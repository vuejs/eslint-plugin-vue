...
function camelCase (str) {
  const firstValidInitialCharIndex = str.split('').findIndex(v => validInitialChar.test(v))
  const [prefix, normalizeStr] = [str.slice(0, firstValidInitialCharIndex), str.slice(firstValidInitialCharIndex)]
  return prefix + normalizeStr
