 ...
 * @param {string} mainSelector The esquery selector of the node it does the final validation.
 * @param {TokenStore} tokenStore The token store object to get tokens.
 * @returns {object} AST event handlers.
 */
module.exports.defineVisitor = function create (context, mainSelector, tokenStore) {
