...
export { isTypeNode } from './ts-ast.js'
export { isExhaustiveSwitch } from './ts-types.js'
 ...
 */
export function getComponentPropsFromTypeDefine(context, propsNode) {
 ...
 */
export function getComponentEmitsFromTypeDefine(context, emitsNode) {
 ...
 */
export function getComponentSlotsFromTypeDefine(context, slotsNode) {
