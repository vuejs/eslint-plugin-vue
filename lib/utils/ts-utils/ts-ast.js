import getScopeModule from '../scope.js'
import * as findVariableModule1 from '@eslint-community/eslint-utils'
import inferRuntimeTypeFromTypeNodeModule2 from './ts-types.js'

const { getScope } = getScopeModule
const { findVariable } = findVariableModule1
const { inferRuntimeTypeFromTypeNode } = inferRuntimeTypeFromTypeNodeModule2
/**
