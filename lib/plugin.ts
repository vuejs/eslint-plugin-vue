...
import attributeHyphenation from './rules/attribute-hyphenation.ts'
import attributesOrder from './rules/attributes-order.js'
import blockLang from './rules/block-lang.js'
import blockOrder from './rules/block-order.ts'
...
import componentDefinitionNameCasing from './rules/component-definition-name-casing.ts'
import componentNameInTemplateCasing from './rules/component-name-in-template-casing.ts'
import componentOptionsNameCasing from './rules/component-options-name-casing.ts'
import customEventNameCasing from './rules/custom-event-name-casing.ts'
...
import htmlCommentContentNewline from './rules/html-comment-content-newline.ts'
import htmlCommentContentSpacing from './rules/html-comment-content-spacing.ts'
import htmlCommentIndent from './rules/html-comment-indent.ts'
import htmlEndTags from './rules/html-end-tags.js'
import htmlIndent from './rules/html-indent.ts'
import htmlQuotes from './rules/html-quotes.js'
import htmlSelfClosing from './rules/html-self-closing.ts'
...
import matchComponentFileName from './rules/match-component-file-name.ts'
import matchComponentImportName from './rules/match-component-import-name.ts'
...
import multiWordComponentNames from './rules/multi-word-component-names.ts'
import multilineHtmlElementContentNewline from './rules/multiline-html-element-content-newline.ts'
...
import nextTickStyle from './rules/next-tick-style.ts'
import noArrowFunctionsInWatch from './rules/no-arrow-functions-in-watch.js'
import noAsyncInComputedProperties from './rules/no-async-in-computed-properties.ts'
import noBareStringsInTemplate from './rules/no-bare-strings-in-template.ts'
...
import noDeprecatedDeleteSet from './rules/no-deprecated-delete-set.ts'
...
import noDeprecatedRouterLinkTagProp from './rules/no-deprecated-router-link-tag-prop.ts'
import noDeprecatedScopeAttribute from './rules/no-deprecated-scope-attribute.js'
import noDeprecatedSlotAttribute from './rules/no-deprecated-slot-attribute.ts'
...
import noExposeAfterAwait from './rules/no-expose-after-await.ts'
import noExtraParens from './rules/no-extra-parens.ts'
...
import noLifecycleAfterAwait from './rules/no-lifecycle-after-await.ts'
...
import noMultipleSlotArgs from './rules/no-multiple-slot-args.ts'
import noMultipleTemplateRoot from './rules/no-multiple-template-root.js'
import noMutatingProps from './rules/no-mutating-props.ts'
...
import noReservedComponentNames from './rules/no-reserved-component-names.ts'
import noReservedKeys from './rules/no-reserved-keys.js'
import noReservedProps from './rules/no-reserved-props.ts'
import noRestrictedBlock from './rules/no-restricted-block.ts'
import noRestrictedCallAfterAwait from './rules/no-restricted-call-after-await.ts'
import noRestrictedClass from './rules/no-restricted-class.ts'
import noRestrictedComponentNames from './rules/no-restricted-component-names.ts'
import noRestrictedComponentOptions from './rules/no-restricted-component-options.ts'
import noRestrictedCustomEvent from './rules/no-restricted-custom-event.ts'
import noRestrictedHtmlElements from './rules/no-restricted-html-elements.js'
import noRestrictedProps from './rules/no-restricted-props.ts'
import noRestrictedStaticAttribute from './rules/no-restricted-static-attribute.ts'
import noRestrictedSyntax from './rules/no-restricted-syntax.js'
import noRestrictedVBind from './rules/no-restricted-v-bind.ts'
import noRestrictedVOn from './rules/no-restricted-v-on.ts'
import noRootVIf from './rules/no-root-v-if.js'
import noSetupPropsReactivityLoss from './rules/no-setup-props-reactivity-loss.ts'
import noSharedComponentData from './rules/no-shared-component-data.js'
import noSideEffectsInComputedProperties from './rules/no-side-effects-in-computed-properties.ts'
...
import noUndefComponents from './rules/no-undef-components.ts'
import noUndefDirectives from './rules/no-undef-directives.ts'
import noUndefProperties from './rules/no-undef-properties.ts'
import noUnsupportedFeatures from './rules/no-unsupported-features.ts'
import noUnusedComponents from './rules/no-unused-components.ts'
import noUnusedEmitDeclarations from './rules/no-unused-emit-declarations.ts'
...
import noUseComputedPropertyLikeMethod from './rules/no-use-computed-property-like-method.ts'
...
import noVTextVHtmlOnComponent from './rules/no-v-text-v-html-on-component.ts'
import noVText from './rules/no-v-text.js'
import noWatchAfterAwait from './rules/no-watch-after-await.ts'
...
import requireExplicitEmits from './rules/require-explicit-emits.ts'
import requireExplicitSlots from './rules/require-explicit-slots.js'
import requireExpose from './rules/require-expose.ts'
...
import requireSlotsAsFunctions from './rules/require-slots-as-functions.ts'
...
import requireTypedRef from './rules/require-typed-ref.ts'
import requireVForKey from './rules/require-v-for-key.js'
import requireValidDefaultProp from './rules/require-valid-default-prop.ts'
import restrictedComponentNames from './rules/restricted-component-names.ts'
import returnInComputedProperty from './rules/return-in-computed-property.ts'
...
import vBindStyle from './rules/v-bind-style.ts'
import vForDelimiterStyle from './rules/v-for-delimiter-style.js'
import vIfElseKey from './rules/v-if-else-key.ts'
import vOnEventHyphenation from './rules/v-on-event-hyphenation.ts'
import vOnHandlerStyle from './rules/v-on-handler-style.js'
import vOnStyle from './rules/v-on-style.js'
import vSlotStyle from './rules/v-slot-style.ts'
import validAttributeName from './rules/valid-attribute-name.js'
import validDefineEmits from './rules/valid-define-emits.ts'
import validDefineOptions from './rules/valid-define-options.ts'
import validDefineProps from './rules/valid-define-props.ts'
import validModelDefinition from './rules/valid-model-definition.js'
import validNextTick from './rules/valid-next-tick.ts'
