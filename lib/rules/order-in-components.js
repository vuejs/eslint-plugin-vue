...
module.exports = {
  meta: {
    ...
    messages: {
      ...
      hasSideEffect:
        'There may be some side effects, the "{{name}}" property should be manually moved above the "{{firstUnorderedPropertyName}}" property on line {{line}}.'
    }
  },
      ...
      for (const [i, property] of properties.entries()) {
        ...
        if (firstUnorderedProperty) {
          ...
          context.report({
            ...
            fix: hasSideEffectsPossibility ? undefined : handleFix,
