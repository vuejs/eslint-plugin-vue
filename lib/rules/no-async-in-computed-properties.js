 ...
 * @author Armano
 */
import * as ReferenceTrackerModule from '@eslint-community/eslint-utils'
import utils from '../utils/index.js'

const { ReferenceTracker } = ReferenceTrackerModule
    ...
    return utils.compositingVisitors(
      {
        ...
        Program(program) {
          ...
          const computedRefs = utils.iterateReferencesTraceMap(tracker, {
            computed: {
