...
module.exports = {
  ...
  create(context) {
    ...
    const [option, optionsPayload] = getRuleOptions(context, __filename)
    const useHyphenated = option !== 'never'
    /** @type {string[]} */
    const ignoredAttributes = optionsPayload.ignore
    /** @type {RegExp[]} */
    const ignoredTagsRegexps = optionsPayload.ignoreTags.map(toRegExp)
    const autofix = optionsPayload.autofix
