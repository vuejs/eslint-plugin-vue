        ...
        oneOf: [
          {
            ...
            description:
              'The `v-slot` style to enforce for custom components, template wrappers and named slots.'
          },
          {
            type: 'object',
            properties: {
              atComponent: {
                ...
                description:
                  'The `v-slot` style to enforce for custom components.'
              },
              default: {
                enum: ['shorthand', 'longform', 'v-slot'],
                description:
                  'The `v-slot` style to enforce for template wrappers.'
              },
              named: {
                enum: ['shorthand', 'longform'],
                description: 'The `v-slot` style to enforce for named slots.'
              }
            },
