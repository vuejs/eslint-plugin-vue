...
const { inferRuntimeType } = require('../utils/ts-utils/ts-ast')
...
module.exports = {
  ...
  create(context) {
     ...
     * @param {ObjectExpression | null} options The model's options object, if any.
     * @return {boolean}
     */
    ...
    return utils.compositingVisitors(
      utils.defineScriptSetupVisitor(context, {
        ...
        onDefineModelEnter(node, model) {
          ...
          // A required model, or one that already declares a default, is fine.
