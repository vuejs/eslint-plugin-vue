...
module.exports = {
  meta: {
    ...
    fixable: null,
    messages: {
      noType: 'Specify type parameter for `{{name}}`, otherwise it will be `any`.'
    },
    schema: []
  },
  ...
  create(context) {
    ...
    if (scriptSetup && !utils.hasAttribute(scriptSetup, 'lang', 'ts') && !utils.hasAttribute(scriptSetup, 'lang', 'typescript')) {
      return {}
    }
