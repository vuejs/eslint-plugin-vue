...
import defineTemplateBodyVisitorModule from '../utils/index.js'

const { defineTemplateBodyVisitor } = defineTemplateBodyVisitorModule
  ...
  create: (context) =>
    defineTemplateBodyVisitor(context, {
      ...
      "VAttribute[directive=false][key.name='class']"(node) {
        ...
        const divider =
          classListWithWhitespace.length > 1 ? classListWithWhitespace[1] : ''
