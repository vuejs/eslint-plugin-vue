...
const FEATURES = {
  // Vue.js 2.5.0+
  'slot-scope-attribute': require('./_syntaxes/slot-scope-attribute'),
  // Vue.js 2.6.0+
  'dynamic-directive-arguments': require('./_syntaxes/dynamic-directive-arguments'),
  'v-slot': require('./_syntaxes/v-slot'),
  // Vue.js 3.0.0+
  'v-model-argument': require('./_syntaxes/v-model-argument'),
  'v-model-custom-modifiers': require('./_syntaxes/v-model-custom-modifiers'),
  'v-is': require('./_syntaxes/v-is'),
  'script-setup': require('./_syntaxes/script-setup'),
  'style-css-vars-injection': require('./_syntaxes/style-css-vars-injection'),
  // Vue.js 3.1.0+
  'is-attribute-with-vue-prefix': require('./_syntaxes/is-attribute-with-vue-prefix'),
  // Vue.js 3.2.0+
  'v-memo': require('./_syntaxes/v-memo'),
  'v-bind-prop-modifier-shorthand': require('./_syntaxes/v-bind-prop-modifier-shorthand'),
  'v-bind-attr-modifier': require('./_syntaxes/v-bind-attr-modifier')
}
