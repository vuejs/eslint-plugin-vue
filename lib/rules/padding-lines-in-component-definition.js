...
import * as isCommentTokenModule from '@eslint-community/eslint-utils'

const { isCommentToken } = isCommentTokenModule
...
export default {
  ...
  create(context) {
    ...
    function replaceLines(currentProperty, nextProperty, fixer) {
      ...
      const start = (commaToken || currentProperty).range[1]
