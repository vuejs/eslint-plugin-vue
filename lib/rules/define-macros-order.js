...
function create(context) {
  ...
  function getTextBetweenTokens(tokenBefore, tokenAfter) {
    const delta = tokenBefore.range[1] - tokenBefore.range[0]
    const count = tokenAfter.range[0] - tokenBefore.range[1]

    return sourceCode.getText(tokenBefore, -delta, count)
  }
