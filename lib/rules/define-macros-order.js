...
function create(context) {
  ...
  /** @type {{ order: [string, string]; defineExposeLast: boolean }[]} */
  const [{ order, defineExposeLast }] = getRuleOptions(context, __filename)
...
module.exports = {
  meta: {
    ...
    defaultOptions: [
      { order: [MACROS_PROPS, MACROS_EMITS], defineExposeLast: false }
    ],
    messages: {
      macrosNotOnTop:
