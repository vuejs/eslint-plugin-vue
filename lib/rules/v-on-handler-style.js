        ...
        oneOf: [
          {
            ...
            description: 'Allow only inline handlers or inline functions.'
          },
          {
            type: 'array',
            items: [
            ...
            maxItems: 2,
            description:
              'Allow handlers by method binding. Allow inline handlers or inline functions where methods handlers cannot be used.'
          }
        ]
      },
      {
        ...
        properties: {
          ignoreIncludesComment: {
            type: 'boolean',
            description:
              'If `true`, do not report inline handlers or inline functions containing comments, even if the preferred style is `"method"`.'
          }
        },
