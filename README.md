...
| :wrench: | [vue/html-element-name-kebab-casing](./docs/rules/html-element-name-kebab-casing.md) | enforce the tag name of the Vue component and HTML element to be `kebab-case` |
