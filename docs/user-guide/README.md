...
Additionally, to have VS Code ignore some rules, you can `override` the rules in ESlint Config. See also "[Configure ESlint](https://eslint.bootcss.com/docs/user-guide/configuring)".
